...
test_normal_imgs , test_normal_labs=_load_images_labels(test_normalDir,NORMAL ,908 , True)
train_normal_imgs , train_normal_labs=_load_images_labels(train_normalDir,NORMAL ,8000, True)
