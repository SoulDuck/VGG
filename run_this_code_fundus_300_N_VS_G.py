...
"""
names = ['normal_train.npy' , 'normal_test_for_glaucoma.npy' ,'glau_train.npy' , 'glau_test.npy']
...
train_imgs = np.vstack([normal_train_imgs , abnormal_train_imgs ,abnormal_train_imgs])
train_labs = np.vstack([normal_train_labs , abnormal_train_labs ,abnormal_train_labs ])
